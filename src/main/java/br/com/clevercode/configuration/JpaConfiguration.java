package br.com.clevercode.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "br.com.clevercode.repositories",
...
public class JpaConfiguration {
	...
	@Value("${datasource.sampleapp.maxPoolSize:5}")
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "br.com.clevercode.model" });
